...
class Case(commands.Cog):
		...
		@commands.command(name="camelcase", help="Converts a string to camelcase", aliases=["cc"], usage="<string>")
		...
		@commands.command(name="pascalcase", help="Converts a string to pascalcase", aliases=["pc"], usage="<string>")
		...
		@commands.command(name="snakecase", help="Converts a string to snakecase", aliases=["snake"], usage="<string>")
		...
		@commands.command(name="uppercase", help="Converts a string to uppercase", aliases=["upper"], usage="<string>")
		...
		@commands.command(name="lowercase", help="Converts a string to lowercase", aliases=["lower"], usage="<string>")
		...
		@commands.command(name = "lispcase", help="Converts a string to lispcase", aliases=["lisp"], usage="<string>")
